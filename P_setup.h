    ...
    <head>
        ...
        <script type = "text/javascript">
            function set_setup(submit) {
                let server = "/setup?timeDay=" + val('timeDay')
                    + "&volBrightnessD=" + val('volBrightnessD')
                    + "&timeNight=" + val('timeNight')
                    + "&volBrightnessN=" + val('volBrightnessN')
                    + "&volBrightnessAuto=" + val_sw('volBrightnessAuto')
                    + "&lowLivelBrightness=" + val('lowLivelBrightness')
                    + "&upLivelBrightness=" + val('upLivelBrightness')
                    + "&MAX7219_ROTATE=" + val('MAX7219_ROTATE')
                    + "&kuOn=" + val('kuOn')
                    + "&kuOff=" + val('kuOff')
                    + "&pressSys=" + val('pressSys')
                    + "&clockNight=" + val_sw('clockNight')
                    + "&isActiveBuzzer=" + val_sw('isActiveBuzzer')
                    + "&timeScrollSpeed=" + val('timeScrollSpeed')
                    + "&animPoint=" + val('animPoint')
                    + "&fontCLOCK=" + val('fontCLOCK')
                    + "&aliData=" + val('aliData')
                    + "&displayData=" + val('displayData')
                    + "&MAX7219_NUM=" + val('MAX7219_NUM')
                    + "&butStat=" + val('butStat')
                    + "&param0=" + val('param0')
                    + "&param1=" + val('param1')
                    + "&param2=" + val('param2')
                    + "&param3=" + val('param3')
                    + "&param4=" + val('param4')
                    + "&sensor00=" + val('sensor00')
                    + "&sensor01=" + val('sensor01')
                    + "&sensor02=" + val('sensor02')
                    + "&sensor03=" + val('sensor03')
                    + "&sensor04=" + val('sensor04')
                    + "&corr00=" + val('corr00')
                    + "&corr01=" + val('corr01')
                    + "&corr02=" + val('corr02')
                    + "&corr03=" + val('corr03')
                    + "&corr04=" + val('corr04')
                    + "&function00=" + val('function00')
                    + "&function01=" + val('function01')
                    + "&function02=" + val('function02')
                    + "&function03=" + val('function03')
                    + "&function04=" + val('function04')
                    + "&function05=" + val('function05')
                    + "&function06=" + val('function06')
                    + "&function07=" + val('function07')
                    + "&function08=" + val('function08')
                    + "&function09=" + val('function09')
                    + "&function10=" + val('function10')
                    + "&function11=" + val('function11')
                    + "&period00=" + val('period00')
                    + "&period01=" + val('period01')
                    + "&period02=" + val('period02')
                    + "&period03=" + val('period03')
                    + "&period04=" + val('period04')
                    + "&period05=" + val('period05')
                    + "&period06=" + val('period06')
                    + "&period07=" + val('period07')
                    + "&period08=" + val('period08')
                    + "&period09=" + val('period09')
                    + "&period10=" + val('period10')
                    + "&period11=" + val('period11');
        ...
        <main>
            <div class="central-unit">
                <nav class="main-menu">
                    ...
                    <span class="ico-text ico-text-active" onclick="get_html('setup.vz');">Настройки</span>
                ...
                <div class="unit-body">
                    <div id="main_unit">
                        <fieldset>
                            <legend>Настройки Часов</legend>
                            <div class="informer">
                                <span class="opt_cn">Здесь можно настроить параметры экрана, отображение данных на экране, параметры и отображение датчиков.</span>
                            </div>
                            <div class="center">
                            <p><span class="opt_cn">Настройки экрана</span></p>
                            <br>
                            <table class="table-centered">
                                <tr>
                                    <td class="right"><span class="opt_cn">Кол-во модулей (8x8)</span></td>
                                    <td><select id = "MAX7219_NUM">
                                ...
                                <tr>
                                    <td class="right"><span class="opt_cn">Вращение внутри модуля</span></td>
                                    <td>
                                        <select id = "MAX7219_ROTATE">
                                ...
                                <tr>
                                  <td class="right"><span class="opt_cn">Скорость бегущей строки</span></td>
                                ...
                                <tr>
                                    <td class="right"><span class="opt_cn">Выравнивание данных</span></td>
                                ...
                                <tr>
                                    <td class="right"><span class="opt_cn">Отображать дату</span></td>
                                    <td>
                                        <select id = "displayData">
                                ...
                                <tr>
                                    <td class="right"><span class="opt_cn">Анимация точек</span></td>
                                    <td>
                                        <select id = "animPoint">
                                ...
                                <tr>
                                    <td class="right"><span class="opt_cn">Шрифт часов</span></td>
                                    <td>
                                        <select id = "fontCLOCK">
                            ...
                            <table id="table__font" class = "table">
                                <tr>
                                    <th><span class="opt_cn"><b> Функция на экране </b></span></th>
                                    <th><span class="opt_cn"><b> Длительность </b></span></th>
                                </tr>
                                <tr>
                        ...
                        <fieldset>
                            <legend>Управление яркостью</legend>
                            <div class="center">
                                <table class="table-centered">
                                    <tr>
                                        <td class="right"><span class="opt_cn">Дневной режим экрана с:</span></td>
                                        ...
                                        <td class="right"><span class="opt_cn">до:</span></td>
                                    ...
                                    <tr>
                                        <td class="right"><span class="opt_cn">Уровень яркости днем:</span></td>
                                        ...
                                        <td class="right"><span class="opt_cn">ночью:</span></td>
                                ...
                                <table>
                                     <tr>
                                        <td class="right"><span class="opt_cn">Уровень c фоторезистора низ:</span></td>
                                        ...
                                        <td class="right"><span class="opt_cn">верх:</span></td>
                        ...
                        <fieldset>
                            <legend>Настройки датчиков</legend>
                            <div class="center">
                                <div class="informer">
                                ...
                                <label class="switch"><span class="opt_cn">Использовать активный базер</span>
                                    <input type="checkbox" id="isActiveBuzzer">
                                    <span class="switch-btn"></span>
                                </label>
                                <br>
                                <table class="table-centered">
                                    <tr>
                                        <td class="right"><span class="opt_cn">Сигнал в начале каждого часа с:</span></td>
                                        <td><select id = "kuOn">
                                            <option value = "0"> 0 </option>
                                            <option value = "1"> 1 </option>
                                            <option value = "2"> 2 </option>
                                    ...
                                    <tr>
                                        <td class="right"><span class="opt_cn">Кнопка подключена к GPIO16 и к:</span></td>
                                ...
                                <table class="table"> <!-- id="table__font" -->
                                    <tr>
                                        <th></th>
                                        <th><span class="opt_cn"><b> Датчик </b></span></th>
                                        <th><span class="opt_cn"><b> Корр. </b></span></th>
                                        <th><span class="opt_cn"><b> Данные </b></span></th>
                                    </tr>
                                    <tr>
                                        <td><select id = "param0">
                                        ...
                                        <td>
                                            <input type="number" class="field form-control" id="corr00" value="{{corr00}}" pattern="\- \d+(\.\d{2})?" min="-9999" max="99999" step="0.01">
                                        </td>
                        ...
                        <span class="save_button" onclick="set_setup(this);">Сохранить настройки</span>
                    </div>
                </div>
            </div>
        </main>
